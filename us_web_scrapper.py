...
with open('C:/Users/Elwyne/Documents/python_project/CSV_Automation/Data/us_county.csv', 'r') as f:
...
def checkPage(domain,url):
    ...
    regexlist = [
                    re.compile(r'(united\s?states|\susa\s)',re.IGNORECASE), # |america|american
...
if __name__=='__main__':
    file = r'C:\Users\Elwyne\Documents\python_project\CSV_Automation\Data\domain_analysis\TODO_domains\us\\' + sys.argv[1]

    #file = r'C:\Users\Elwyne\Documents\python_project\CSV_Automation\Data\domain_analysis\TODO_domains\us\domain_export.csv'
    ...
    df.loc[((df['Web Check'] == 'WEB FALSE') | (df['Web Check'] == 'FAILED') | (df['Web Check'] == 'WEB UNKNOWN'))
            & (((df[' Country'] == 'us') | (df[' Country'] == 'united states') | (df[' Country'] == 'unitedstates'))
                | ((df[' Address'].str.contains('united')) & (df[' Address'].str.contains('states')))), 'Auto_Check'] = 'Unknown US'
    ...
    #df.to_csv(r'C:\Users\Elwyne\Documents\python_project\CSV_Automation\Data\domain_analysis\TODO_domains\us\web\WS')
    df.to_csv(r'C:\Users\Elwyne\Documents\python_project\CSV_Automation\Data\domain_analysis\TODO_domains\us\web\WS_' + sys.argv[1])